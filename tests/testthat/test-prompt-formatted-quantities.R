...
testthat::test_that("two-factor logistic interaction prompt includes probability and odds-ratio payload", {
  ...
  testthat::expect_match(promptBlock, "Odds(Pass = \"Pass\" vs Pass = \"Fail\") odds ratio comparing Attend = Yes with Attend = No when Gender = Female", fixed = TRUE)
  testthat::expect_match(promptBlock, "Odds(Pass = \"Pass\" vs Pass = \"Fail\") odds ratio comparing Attend = Yes with Attend = No when Gender = Male", fixed = TRUE)
  testthat::expect_match(promptBlock, "Ratio of odds ratios for Odds(Pass = \"Pass\" vs Pass = \"Fail\"): Attend effect at Gender = Male versus Gender = Female", fixed = TRUE)
  testthat::expect_match(promptBlock, "95% confidence interval", fixed = TRUE)
  testthat::expect_no_match(promptBlock, "coefficient scale", fixed = TRUE)
  ...
  testthat::expect_match(prompt, "Odds(Pass = \"Pass\" vs Pass = \"Fail\") odds ratio comparing Attend = Yes with Attend = No when Gender = Male", fixed = TRUE)
  testthat::expect_match(prompt, "Ratio of odds ratios for Odds(Pass = \"Pass\" vs Pass = \"Fail\"): Attend effect at Gender = Male versus Gender = Female", fixed = TRUE)
})
