...
testthat::test_that("Diamonds II to IV examples load with log-log formulas", {
  ...
  testthat::expect_true(is.ordered(diamondsII$data$cut))
  testthat::expect_true(is.ordered(diamondsII$data$color))
  testthat::expect_true(is.ordered(diamondsII$data$clarity))
  testthat::expect_true(is.ordered(diamondsIV$data$cut))
  testthat::expect_true(is.ordered(diamondsIV$data$color))
  testthat::expect_true(is.ordered(diamondsIV$data$clarity))
