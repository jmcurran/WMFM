  ...
  fluidPage(
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        h4("Developer mode"),
        div(
          class = "wmfm-developer-mode-toggle-control",
          checkboxInput(
