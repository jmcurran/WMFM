...
buildWmfmLanguageContractText = function(context = c("summary", "contrast")) {
  ...
  contractBody = paste(
    ...
    "  Use probabilities for fitted values, baselines, and group-level outcomes.",
    "  Use odds multipliers or odds ratios only for effects and direct comparisons.",
    "  Do not present raw group odds as the main interpretation.",
    "  Do not switch from a probability statement to a raw-odds statement about the same fitted value.",
    "  When interpreting confidence intervals for odds multipliers or odds ratios, describe them relative to the no-change value of 1 rather than saying they are above or below zero.",
