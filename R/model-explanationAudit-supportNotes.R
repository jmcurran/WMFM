...
buildWmfmExplanationAuditSupportNotes = function(audit) {
  ...
  data.frame(
    ...
    purpose = c(
      ...
      "Records user-created derived variables used by the fitted model.",
      "Records deterministic original-response-scale quantities when response back-transformation is available.",
    ...
    downstreamUse = c(
      ...
      "Safe for teaching-summary baseline explanations and UI labels.",
      "Safe for teaching-summary derived-variable notes; not sufficient for automatic back-transformation by itself.",
      "Safe for explanation prompting; do not ask the language model to invent rows that are absent.",
