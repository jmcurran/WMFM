...
buildWmfmLanguageContractText = function(context = c("summary", "contrast")) {
  ...
  contractBody = paste(
    ...
    "- Each key effect should end with a short concluding statement about what the data indicate (e.g. a clear increase, a strong decrease, or an uncertain effect).",
    "- You may use plain-language evidence phrases such as \"the data indicate\", \"this shows\", or \"this provides strong evidence\", but avoid formal statistical terminology.",
